# SIDE_QUEST_ROBOTICS
Robotics Team for the SIDE QUEST experience a project by Albert Rajkumar,  at the Australian Rover Challenge 2026

### Repository Contribution Rules:
. Please make sure you have been invited as a contributor
## Project: Autonomous Behaviour Developement for Rover
...
Environment: Best run on Windows/Linux (Recommended: NVIDIA dGPU for vision processing) if working with 
...
Create a feature branch for every task: git checkout -b feature/your-task-name. (MANDATORY)
...
Code Review: The Lead Developer (@isthissmanas) must be tagged for final review to ensure motor safety and coordinate limits.
